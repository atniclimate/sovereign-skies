...
export default function Map() {
  ...
  const { alerts, alertsWithGeometry, alertsByType, loading: alertsLoading, error: alertsError, lastUpdated, alertCount, refresh: refreshAlerts } = useAlerts(includeCanada);
  ...
  return (
    <div className="map-viewport">
      ...
      <div className="map-sidebar">
        ...
        {!loading && (
          <div className="module-panel">
            ...
            <div className="sidebar-list">
              ...
              {alertCount === 0 && riverSummary.flooding === 0 && (
        ...
        <div className="module-panel">
          ...
          <div className="module-panel-content">
            ...
            <label className="layer-toggle">
              ...
              />
              <span className="layer-toggle-indicator" style={{ '--toggle-color': 'var(--color-accent)' }} />
        ...
        <div className="module-panel">
          <div className="module-panel-header">
            <span className="text-label-sm text-muted">Alert Key</span>
          </div>
          <div className="module-panel-content">
